<template>
	...
	<div class="mt-12 pb-8 lg:pb-0 w-5/5 md:w-4/5 lg:w-full mx-auto flex flex-wrap items-center justify-between">
		<a class="link" href="https://github.com/garpunkal" target="_blank" rel="noopener"
			><svg class="h-6 fill-current text-gray-600 hover:text-brand dark:text-brand dark:hover:text-white hover:animate-pulse" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="24px" height="100%" title="GitHub">
				<title>GitHub</title>
				<path
		...
		<a class="link" href="https://www.linkedin.com/in/garpunkal/" target="_blank" rel="noopener" title="LinkedIn">
			<svg class="h-6 fill-current text-gray-600 hover:text-brand dark:text-brand dark:hover:text-white hover:animate-pulse" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="24px" height="100%">
		...
		<a class="link" href="https://www.reddit.com/user/garpunkal" target="_blank" rel="noopener" title="Reddit"
			><svg class="h-6 fill-current text-gray-600 hover:text-brand dark:text-brand dark:hover:text-white hover:animate-pulse" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="24px" height="100%">
				<title>Reddit</title>
				<path
		...
		<a class="link" href="https://www.nuget.org/profiles/garpunkal" target="_blank" rel="noopener" title="Nuget"
			><svg class="h-6 fill-current text-gray-600 hover:text-brand dark:text-brand dark:hover:text-white hover:animate-pulse" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
				<title>NuGet</title>
				<path
		...
		<a id="switchTheme" class="inline-flex cursor-pointer text-sm">
			<svg class="h-6 fill-current text-gray-600 hover:text-brand dark:text-brand dark:hover:text-white hover:animate-pulse" viewBox="0 0 24 24" width="24px" role="img" height="100%" xmlns="http://www.w3.org/2000/svg">
