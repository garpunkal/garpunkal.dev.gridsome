		...
		<div class=" sm:pl-6 mt-6 sm:mt-0 flex items-start justify-start lg:justify-end mb-5 ">
			<a v-if="item.url" :href="item.url" target="_blank" rel="noopener" :title="item.title">
				<img
					...
					class=" rounded-lg lg:rounded-l-lg flex object-contain dark:brightness-50 dark:hover:brightness-100 w-100pixel h-100pixel border-brand dark:border-brand-dark border-4"
					width="100"
					height="100"
					loading="lazy"
					:title="item.logo.alt"
