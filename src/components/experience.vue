<template>
	<div class="lg:grid lg:grid-cols-5 md:pl-8 pl-6 text-gray-300">
		...
		<div
			class=" col-span-3 sm:pl-6 mt-6 sm:mt-0 md:pr-5 lg:border-r-2 lg:border-brand lg:border-opacity-25 pb-10 "
		>
			<h3
			...
			<p class="font-smaller title-font text-sm mb-5">
				...
				>
				<span
					class="inline-block py-1 px-2 text-gray-400 dark:text-gray-500 text-xs"
					>{{ GetMonths(item.from, item.to) }}</span
				>
			</p>
			<div
