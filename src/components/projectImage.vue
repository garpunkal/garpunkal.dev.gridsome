<template>
	<figure class="relative">
		...
		<figcaption class="absolute px-2 py-1 text-xs text-white rounded-tr-lg rounded-br-lg rounded-bl-lg -left-1 -bottom-1 md:px-4 md:py-2 bg-ocean dark:bg-mirage dark:text-gray-400 ">
			{{ item.title }}
		</figcaption>
	</figure> 
</template>
