		...
		<div class="center">
			<a v-if="item.canonical_url" :href="item.canonical_url" target="_blank" rel="noopener" :title="item.title">
				<figure class="relative">
					<img :src="item.cover_image" :alt="item.title" :title="item.alt" class="dark:brightness-50 dark:hover:brightness-100 rounded-t" loading="lazy" />
				</figure>
			</a>
		</div>
		<div class="p-6">
			...
			<div class="my-3">
				<div class="inline-flex items-center justify-end w-full text-xs font-medium">
					
					<span class="mx-2">
						<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 inline-flex  align-bottom" viewBox="0 0 20 20" fill="currentColor">
