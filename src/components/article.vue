    ...
    <div class="p-6">
      ...
      <div class="w-full flex items-center">
        <div class="w-6/12 flex justify-start">
          <div class="my-3">
            <div
              class="inline-flex items-center px-2 py-0.5 mr-1 rounded text-xs font-medium bg-gray-100 text-gray-800"
        ...
        <div class="w-6/12 flex justify-end">
          ...
          <span
            class="text-white inline-flex items-center leading-none text-sm"
          >
            <svg
              class="w-4 h-4 mr-1"
              stroke="currentColor"
