  ...
  >
    ...
    >
      <div class="p-4 md:p-12 text-center lg:text-left">
        ...
        <h1
          class="text-4xl font-extrabold sm:text-6xl tracking-tighter lg:text-6xl text-brand dark:text-gray-300"
        >
          Gareth Wright
        </h1>
        <h2
          class="text-2xl font-extrabold sm:text-3xl tracking-tighter lg:text-4xl text-brand-dark dark:text-gray-500"
        >
         <a
       ...
       <p
          class="mt-5 pt-5 text-gray-600 dark:text-gray-300 text-sm lg:text-sm flex items-center justify-center lg:justify-start"
        >
          <svg
        ...
        >
          <a id="switchTheme" class="inline-flex cursor-pointer">
            <svg
