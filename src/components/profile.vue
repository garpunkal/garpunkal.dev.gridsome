<template>
	<section
		class="max-w-6xl flex items-center h-auto lg:h-144 flex-wrap mx-auto lg:mx-10 xl:mx-auto mt-20 mb-10 md:my-12 lg:my-18"
	>
		<div
			id="profile"
			class="w-full lg:w-3/5 rounded-lg md:rounded-r-lg lg:rounded-l-lg xl:rounded-r-none shadow-2xl-black bg-white dark:bg-brand-dark dark:text-gray-300 mx-6 lg:mx-0"
		>
