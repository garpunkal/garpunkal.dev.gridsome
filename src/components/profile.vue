	...
	<section class="max-w-6xl flex items-center h-auto lg:h-144 flex-wrap mx-auto lg:mx-10 xl:mx-auto mt-20 mb-10 md:my-12 lg:my-18">
		<div id="profile" class="w-full lg:w-3/5 rounded-lg md:rounded-r-lg lg:rounded-l-lg xl:rounded-r-none shadow-2xl-black bg-white dark:bg-brand-dark dark:text-gray-300 mx-6 lg:mx-0">
			<div class="p-4 md:p-12 text-center lg:text-left">
				<ProfileImageSmall />
				<h1 class="mt-3 text-4xl font-extrabold tracking-tighter lg:text-6xl ">
					Gareth Wright
				</h1>
				...
				<p class="pt-2 text-gray-600 dark:text-gray-300 text-sm lg:text-sm flex items-start justify-center lg:justify-start">
					<svg class="hidden md:block h-5 fill-current text-brand dark:text-brand pr-2" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="24px" height="100%">
						<title>Umbraco</title>
						<path
				...
				<p class="pt-2 text-gray-600 dark:text-gray-300 text-sm lg:text-sm flex items-center justify-center lg:justify-start">
					<svg class="hidden md:block h-5 fill-current text-brand dark:text-brand pr-2" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="24px" height="100%">
		...
		<ProfileImage /> <DownArrow id="projects" />
	</section>
</template>
<script>
...
export default {
	name: "Profile",
	components: { SocialLinks, DownArrow, ProfileImage, ProfileImageSmall },
};
</script>
