<template>
  <Layout>
    <div
      class="max-w-6xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0"
    >
      <div
        id="profile"
