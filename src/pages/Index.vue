            ...
            <div class="md:p-2 p-1 w-full">
              ...
              >
                <g-image
                  ...
                  src="~/assets/images/nextbase.png"
                  fit="cover"
                  width="601"
                  height="361"
                  position="center top"
            ...
            <div class="md:p-2 p-1 w-full md:w-1/2">
              ...
              >
                <g-image
                  alt="Sunbites"
                  class="w-full object-cover h-full object-center block rounded-lg lg:rounded-l-lg"
                  src="~/assets/images/sunbites.png"
                  fit="cover"
                  width="503"
                  height="303"
                  position="center top"
            ...
            <div class="md:p-2 p-1 w-full md:w-1/2">
              ...
              >
                <g-image
                  alt="Wright Hassall"
                  class="w-full object-cover h-full object-center block rounded-lg lg:rounded-l-lg"
                  src="~/assets/images/wrighthassall.png"
                  fit="cover"
                  width="500"
                  height="300"
                  position="left top"
            ...
            <div class="md:p-2 p-1 w-full">
              ...
              >
                <g-image
                  alt="Madame Tussauds"
                  class="w-full object-cover h-full object-center block rounded-lg lg:rounded-l-lg"
                  src="~/assets/images/madametussauds.png"
                  fit="cover"
                  width="502"
                  height="302"
                  position="center top"
            ...
            <div class="md:p-2 p-1 w-full md:w-1/2">
              ...
              >
                <g-image
                  alt="Crimestoppers"
                  class="w-full object-cover h-full object-center block rounded-lg lg:rounded-l-lg"
                  src="~/assets/images/crimestoppers.png"
                  fit="cover"
                  width="500"
                  height="300"
                  position="left top"
            ...
            <div class="md:p-2 p-1 w-full">
              <a href="http://www.londoneye.com" target="_blank" rel="noopener">
                <g-image
                  alt="London Eye"
                  class="w-full object-cover h-full object-center block rounded-lg lg:rounded-l-lg"
                  src="~/assets/images/londoneye.png"
                  fit="cover"
                  width="600"
                  height="360"
                  position="top"
            ...
            <div class="md:p-2 p-1 w-full">
              ...
              >
                <g-image
                  alt="Naked Juice"
                  class="w-full object-cover h-full object-center block rounded-lg lg:rounded-l-lg"
                  src="~/assets/images/nakedjuice.png"
                  fit="cover"
                  width="502"
                  height="302"
                  position="top"
            ...
            <div class="md:p-2 p-1 w-full md:w-1/2">
              ...
              >
                <g-image
                  alt="Godolphin"
                  class="w-full object-cover h-full object-center block rounded-lg lg:rounded-l-lg"
                  src="~/assets/images/godolphin.png"
                  fit="cover"
                  width="503"
                  height="303"
                  position="top"
            ...
            <div class="md:p-2 p-1 w-full md:w-1/2">
              ...
              >
                <g-image
                  alt="Taylor Root"
                  class="w-full object-cover h-full object-center block rounded-lg lg:rounded-l-lg"
                  src="~/assets/images/taylorroot.png"
                  fit="cover"
                  width="501"
                  height="301"
                  position="left top"
            ...
            <div class="md:p-2 p-1 w-full">
              ...
              >
                <g-image
                  alt="littlefreddie"
                  class="w-full object-cover h-full object-center block rounded-lg lg:rounded-l-lg"
                  src="~/assets/images/littlefreddie.png"
                  fit="cover"
                  width="600"
                  height="360"
                  position="top"
          ...
          <div class="lg:grid lg:grid-cols-5 md:pl-8 pl-6">
            ...
            >
              ...
              <ul class="list-outside list-disc font-smaller text-sm pl-5">
                ...
                <li>Staff recruitment, training and resourcing.</li>
                <li>
                  Improving processes, security and efficiency on technical
                  projects.
                </li>
                <li>
                  C# MVC development utilising Umbraco, Sitecore and Sitefinity.
                </li>
                <li>Umbraco Gold Partner.</li>
                <li>Certified Umbraco Expert.</li>
                <li>Certified Sitecore XP8 Developer.</li>
                <li>
                  Extending Umbraco by creating C# and AngularJS packages.
                </li>
                ...
                <li>
                  ...
                  >
                    ...
                    <li>Azure DNS.</li>
                    <li>App services / App service plans.</li>
          ...
          <div class="lg:grid lg:grid-cols-5 md:pl-8 pl-6">
            ...
            >
              ...
              <ul class="list-outside list-disc font-smaller text-sm pl-5">
                ...
                <li>C# MVC and WebForms.</li>
                <li>Umbraco 6 and 7 experience.</li>
                <li>Sitecore 8 experience.</li>
                <li>
                  Lead developer on top brand projects with tight deadlines,
                  which included team leadership and client liaising.
                </li>
                <li>3rd party integration with various API's.</li>
                <li>Technical documentation and solution development.</li>
                <li>Core developer of in-house content management system.</li>
                <li>Pitching to potential new clients, with success.</li>
                <li>
                  <a
                    rel="noopener"
                    href="https://www.w3award.com/winners/list/view/?search=jaywing&amp;event=29&amp;award=1"
                    target="_blank"
          ...
          <div class="lg:grid lg:grid-cols-5 md:pl-8 pl-6">
            ...
            >
              ...
              <ul class="list-outside list-disc font-smaller text-sm pl-5">
                ...
                <li>Core developer on large FMCG websites.</li>
                <li>
                  Multilingual experience with Arabic sites, including
                  bidirectional layouts.
                </li>
                <li>
                  Building websites for high profile clients, under tight
                  deadlines alongside creative and client teams. 
                </li>
                <li>
                  Creating bulk email notification systems including queuing and
                  SMTP error handling.
                </li>
                <li>
                  Database optimisation and architecture for high load websites.
                </li>
                <li>Lead on development of a dynamic survey builder. </li>
              </ul>
            </div>
          ...
          <div class="lg:grid lg:grid-cols-5 md:pl-8 pl-6">
            ...
            >
              ...
              <ul class="list-outside list-disc font-smaller text-sm pl-5">
                ...
                <li>
                  Working with bespoke CMS systems to create and maintain entire
                  websites.
                </li>
                <li>
                  Following storyboards and functionality specs agreed by all
                  parties.
                </li>
                <li>
                  Maintaining ASP websites, whilst developing my knowledge of
                  the technology and C#.net.
                </li>
                <li>
                  Using XML and SOAP to connect to web services for online
                  booking engines.
                </li>
              </ul>
            </div>
          ...
          <div class="lg:grid lg:grid-cols-5 md:pl-8 pl-6">
            ...
            >
              ...
              <ul class="list-outside list-disc font-smaller text-sm pl-5">
                ...
                <li>
                  Full commercial e-commerce solutions, including ordering
                  systems and content management.
                </li>
                <li>SEO awareness.</li>
                <li>Working along side SEO team with proven practices.</li>
                <li>
                  Responsibilities for quality, security, performance and ease
                  of use.
                </li>
              </ul>
            </div>
          ...
          <div class="lg:grid lg:grid-cols-5 md:pl-8 pl-6">
            ...
            >
              ...
              <ul class="list-outside list-disc font-smaller text-sm pl-5">
                ...
                <li>
                  Controlling the entire TNT Magazine website and development of
                  ASP model.
                </li>
          ...
          <div class="lg:grid lg:grid-cols-5 md:pl-8 pl-6">
            ...
            >
              ...
              <ul class="list-outside list-disc font-smaller text-sm pl-5">
                ...
                <li>
                  Statistics analyst, including search optimisation and site
                  accessibility.
                </li>
                <li>
                  Frequent collaboration and training with domestic and foreign
                  contacts.
                </li>
                <li>Development of EMEA Personal Computing websites.</li>
                <li>Lead developer for rollout of ibm.com design updates.</li>
              </ul>
            </div>
