  ...
  <Layout>
    <div class="max-w-6xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
      <div id="profile" class="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg shadow-2xl bg-white mx-6 lg:mx-0">
        <div class="p-4 md:p-12 text-center lg:text-left">
          ...
          <div class="block lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover bg-center" style="
              background-image: url('https://en.gravatar.com/avatar/e81a3e793038ca4c8062a275ee210a94?size=600');
            "></div>
      ...
      <div class="w-full lg:w-2/5">
        ...
        <img src="https://en.gravatar.com/avatar/e81a3e793038ca4c8062a275ee210a94?size=600"
      ...
      <div class="flex justify-center w-full pt-20 md:pt-0">
        <a href="#content">
        <svg class="animate-bounce w-6 h-6 text-amber-900" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="white">
      ...
      <div class="container px-5 py-24 mx-auto flex flex-wrap">
        <div class="flex w-full mb-20 flex-wrap">
          ...
          <p class="lg:pl-6 lg:w-2/3 mx-auto leading-relaxed text-base">
            I love working with clients throughout the
            longevity of a project, from initial conversations to delivery and
            further. They're part of the team that ultimately delivers great
            creative projects to help businesses succeed.
          </p>
        </div>
